...
<div class="min-h-screen p-6 bg-gray-100 flex items-center justify-center mt-5">
    <div class="container max-w-screen-lg mx-auto">
      <div>
        <h2 class="font-semibold text-xl text-gray-600 mb-6 underline decoration-blue-500 decoration-2 underline-offset-4 hover:decoration-blue-700">{{ $name }}</h2>
              ...
              <div class="grid gap-4 gap-y-8 text-sm grid-cols-1 md:grid-cols-5">
                ...
                <div class="md:col-span-5 text-right">
                  <div class="inline-flex items-end gap-2">
                    <button wire:click='editarProduto' class="bg-gradient-to-r from-blue-500 to-cyan-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded hover:scale-105">SALVAR</button>
                    <button wire:click='home' class="bg-gradient-to-r from-red-400 to-orange-400 py-2 px-4 rounded hover:scale-105 text-white font-bold">CANCELAR</button>                  
                  </div>
                </div>
